...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default=ROOT / "models/hotBed_yolo5s.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default=ROOT / "data/hotBed_data.yaml", help="dataset.yaml path")
